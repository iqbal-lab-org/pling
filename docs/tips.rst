...
- **Directly edit the html files.** This is generally a bit finicky though. The generated graph HTML is expected to include a Cytoscape.js source tag; Pling checks for and repairs missing Cytoscape.js tags after visualisation generation.
